...
if($lastInsertId)
{
$msg="Query Sent. Successfully submitted, click the payment button to complete payment";
}
else 
{
    ...
    <div  class="row">
      <div class="col-md-6">
        ...
        <div class="contact_form gray-bg">
          ...
          <a href="pay.php"><input type="submit" name="submit" class="btn" value="Payment"></a>
        </div>
      </div>
      </div>
    </div>
